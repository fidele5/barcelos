                                    ...
                                    <div class="row m-auto">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control champ" value="{{ $user->name }}" name="name" id="fname3" placeholder="Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control champ" name="email" value="{{ $user->email }}" id="price" placeholder="Email">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="location_id" class="form-control">
                                                    ...
                                                    @foreach ($locations as $location)
                                                         <option value="{{ $location->id }}" {{ ($location->id == $user->location_id)?"selected":"" }}>{{ $location->designation }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="role" class="form-control">
                                                    ...
                                                    @foreach ($roles as $role)
                                                         <option value="{{ $role->id }}" {{ ($role->id == $selected_role_id) ? "selected":""}}>{{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
